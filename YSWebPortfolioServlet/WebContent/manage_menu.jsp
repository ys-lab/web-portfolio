			...
			<div class="container">
                ...
                <div class="collapse navbar-collapse" id="bs-navbar-collapse">
                    <ul class="nav navbar-nav main-navbar-nav">
                        <li class=""><a href="Index" title="ホーム">HOME</a></li>
                        <li class="active"><a href="Manage?target=Menu" name="menu-list-modify" title="メニュー管理">MENU MANAGE</a></li>
                        <li class=""><a href="Manage?target=Page" name="page-modify" title="サブメニュー管理">PAGE MANAGE</a></li>
                        <li class=""><a href="Manage?target=Contents" name="" title="コンテンツ管理">CONTENT MANAGE</a></li>
                    </ul>                           
                </div><!-- /.navbar-collapse -->                
				<!-- END MAIN NAVIGATION -->
			</div>
				...
				<section class="page col-sm-9">
                    ...
                    <div class="entry">
                    	<table class="menu-list-modify">
							<thead class="table-list tab_menu_lists">
								<th>MENU NAME</th>
								<th>MENU TITLE</th>
								<th>MENU LINK</th>
								<th>MENU TYPE</th>
							...
							<thead class="table-list tab_topic_lists">
							...
							<thead class="table-list tab_topic_sub_lists">
								<th>MASTER TOPIC NAME</th>
								<th>SUB TOPIC NAME</th>
								<th>SUB TOPIC TITLE</th>
								<th>SUB TOPIC LINK</th>
								<th>SUB TOPIC TYPE</th>
								<th>OPTION</th>
							</thead>
							<tbody class="table-list tab_menu_lists list-sortable">
								<%
								out.write("<tr class='ui-state-default menu-row hidden' num='' name='tab_menu_lists'><td class='hidden'><input class='column_name tab_menu_num' name='tab_menu_num' type='text' value=''></td><td><input class='column_name tab_menu_name' name='tab_menu_name' type='text' value=''></td><td><input class='column_name tab_menu_title' name='tab_menu_title' type='text' value=''></td><td><input class='column_name tab_menu_link' name='tab_menu_link' type='text' value=''></td><td><select class='column_name tab_menu_type' name='tab_menu_type'><option value='1'>1</option><option value='2'>2</option></select></td><td><a class='menu-modify'><i class='fa fa-pencil-square-o'></i></a><a class='menu-remove'><i class='fa fa-times'></i></a></td></tr>");
                				...
                				for(int i=0; i<jsonMenuArray.size(); i++){
				                	...
				                	out.write("<tr class='ui-state-default' num='" + num + "' name='tab_menu_lists'>");
				                	out.write("<td class='hidden'><input class='column_name tab_menu_num' name='tab_menu_num' type='text' value='" + tab_menu_num + "'></td>");
				                	out.write("<td>");
				            		out.write("<input class='column_name tab_menu_name' name='tab_menu_name' type='text' value='" + tab_menu_name + "'");
				            		out.write("</td>");
				            		out.write("<td>");
				            		out.write("<input class='column_name tab_menu_title' name='tab_menu_title' type='text' value='" + tab_menu_title + "'");
				            		out.write("</td>");
				            		out.write("<td>");
				            		out.write("<input class='column_name tab_menu_link' name='tab_menu_link' type='text' value='" + tab_menu_link + "'");
				            		out.write("</td>");
				            		out.write("<td>");
				            		out.write("<select class='column_name tab_menu_type' name='tab_menu_type'>");
				            		for(int j=1; j<3; j++){
				            			if(j == tab_menu_type){
							...
							<tbody class="table-list tab_topic_lists list-sortable hidden">
								<%
								out.write("<tr class='ui-state-default menu-row hidden' num='' name='tab_topic_lists'><td class='hidden'><input class='column_name tab_topic_num' name='tab_topic_num' type='text' value=''></td>");
								out.write("<td>");
			            		out.write("<select class='column_name tab_menu_name' name='tab_menu_name'>");
			            		for(int j=0; j<menuNames.length; j++){
			                		if(j==0){
			                			out.write("<option selected value='" + menuNames[j] +"'>" + menuNames[j] +"</option>");
			                		} else {
			                			out.write("<option value='" + menuNames[j] +"'>" + menuNames[j] +"</option>");
			                		}
			                	}
			            		out.write("</select");
			            		out.write("</td>");
								out.write("</td><td><input class='column_name tab_topic_name' name='tab_topic_name' type='text' value=''></td><td><input class='column_name tab_topic_title' name='tab_topic_title' type='text' value=''></td><td><input class='column_name tab_topic_link' name='tab_topic_link' type='text' value=''></td><td><select class='column_name tab_topic_type' name='tab_topic_type'><option value='1'>1</option><option value='2'>2</option></select></td><td><a class='menu-modify'><i class='fa fa-pencil-square-o'></i></a><a class='menu-remove'><i class='fa fa-times'></i></a></td></tr>");
								...
								for(int i=0; i<jsonTopicArray.size(); i++){
				            		...
				            		out.write("<select class='column_name tab_menu_name' name='tab_menu_name'>");
				            		for(int j=0; j<menuNames.length; j++){
				                		if(menuNames[j].equals(tab_menu_name)){
				                			out.write("<option selected value='" + menuNames[j] +"'>" + menuNames[j] +"</option>");
				                		} else {
				                			out.write("<option value='" + menuNames[j] +"'>" + menuNames[j] +"</option>");
				                		}
				            		...
				            		out.write("</td>");
				            		out.write("<td>");
				            		out.write("<input class='column_name tab_topic_name' name='tab_topic_name' type='text' value='" + tab_topic_name + "'");
				            		out.write("</td>");
				            		out.write("<td>");
							...
							<tbody class="table-list tab_topic_sub_lists list-sortable hidden">
								<%
								out.write("<tr class='ui-state-default menu-row hidden' num='' name='tab_topic_sub_lists'><td class='hidden'><input class='column_name tab_topic_sub_num' name='tab_topic_sub_num' type='text' value=''></td><td><input class='column_name tab_topic_name' name='tab_topic_name' type='text' value=''></td><td><input class='column_name tab_topic_sub_name' name='tab_topic_sub_name' type='text' value=''></td><td><input class='column_name tab_topic_sub_title' name='tab_topic_sub_title' type='text' value=''></td><td><input class='column_name tab_topic_sub_link' name='tab_topic_sub_link' type='text' value=''></td><td><select class='column_name tab_topic_sub_type' name='tab_topic_sub_type'><option value='1'>1</option><option value='2'>2</option></select></td><td><a class='menu-modify'><i class='fa fa-pencil-square-o'></i></a><a class='menu-remove'><i class='fa fa-times'></i></a></td></tr>");
				                for(int i=0; i<jsonSubTopicArray.size(); i++){
				                	try{
				                		JSONObject topicTab = (JSONObject) jsonSubTopicArray.get(i);
					                	...
					                	System.out.println(tab_topic_sub_name);
					            		
					                	out.write("<tr class='ui-state-default' num='" + num + "' name='tab_topic_sub_lists'>");
					                	out.write("<td class='hidden'><input class='column_name tab_topic_sub_num' name='tab_topic_sub_num' type='text' value='" + tab_topic_sub_num + "'></td>");
					                	out.write("<td>");
					            		out.write("<input class='column_name tab_topic_name' name='tab_topic_name' type='text' value='" + tab_topic_name + "'");
					            		out.write("</td>");
					            		out.write("<td>");
					            		out.write("<input class='column_name tab_topic_sub_name' name='tab_topic_sub_name' type='text' value='" + tab_topic_sub_name + "'");
					            		out.write("</td>");
					            		out.write("<td>");
					            		out.write("<input class='column_name tab_topic_title' name='tab_topic_sub_title' type='text' value='" + tab_topic_sub_title + "'");
					            		out.write("</td>");
					            		out.write("<td>");
					            		out.write("<input class='column_name tab_topic_link' name='tab_topic_sub_link' type='text' value='" + tab_topic_sub_link + "'");
					            		out.write("</td>");
					            		out.write("<td>");
					            		out.write("<select class='column_name tab_topic_sub_type' name='tab_topic_sub_type'>");
					            		for(int j=1; j<3; j++){
					            			if(j == tab_topic_sub_type){
					            				out.write("<option value='" + j + "' selected>" + j + "</option>");
					            			} else {
					            				out.write("<option value='" + j + "'>" + j + "</option>");
					            			}
							...
							<tbody class="menu-option">
								<tr>
									<td colspan="2">
										<a class="menu-add"><i class='fa fa-plus'></i>ADD NEW MENU</a>
									</td>
									<td colspan="2">
										<a class="menu-save"><i class='fa fa-floppy-o'></i>SAVE CHANGES</a>
									</td>
								</tr>
							</tbody>
						</table>
                ...
                <aside class="sidebar col-sm-3">
	                <div class="widget">
	                    ...
	                    <ul class="modify-option">
	                    	<li><a class="active" name="tab_menu_lists">MODIFY MENU NAME</a></li>
	                    	<li><a class="" name="tab_topic_lists">MODIFY TOPIC NAME</a></li>
	                    	<li><a class="" name="tab_topic_sub_lists">MODIFY TOPIC SUB NAME</a></li>
	                    </ul>
	                </div>
	            </aside>
			</div>
